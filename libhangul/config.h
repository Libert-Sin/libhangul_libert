...
/* Define to 1 if you enabled to load external keyboards */
#define ENABLE_EXTERNAL_KEYBOARDS 1

/* Define to 1 if translation of program messages is requested. */
#define ENABLE_NLS 1
...
#define PACKAGE_BUGREPORT "https://github.com/libhangul/libhangul"
